...
public class ERPQuoteToolTest 
{
	...
	@Test
	public void testCalculateIndependantQuote() 
	{
		int[] services = {1, 3, 5, 7, 0, 0, 0, 8};
		int contract = 3;
		int[] result = {2600, 165, 8540};
		assertArrayEquals(ERPQuoteTool.calculateIndependantQuote(services, contract), result);
		
		int[] services2 = {1, 2, 3, 0, 0, 0, 0, 0};
		int contract2 = 1;
		int[] result2 = {1500, 120, 2940};
		assertArrayEquals(ERPQuoteTool.calculateIndependantQuote(services2, contract2), result2);
	}
